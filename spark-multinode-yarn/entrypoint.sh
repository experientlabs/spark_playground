...
then
  ...
  hdfs dfs -mkdir -p /home/spark/data
  echo "Created /home/spark/data hdfs dir"


  # copy the data to the data HDFS directory
  hdfs dfs -copyFromLocal /home/spark/data/* /home/spark/data
  hdfs dfs -ls /home/spark/data
